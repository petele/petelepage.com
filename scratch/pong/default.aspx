 ...
 *-->
    ...
    <link href="myPong.css?v=0a" rel="Stylesheet" type="text/css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" Runat="Server">
    ...
    <audio id="sndBounce" preload="auto">
    	<source src="boink.mp3?v=0" type="audio/mpeg"/>
    </audio>
    ...
    <div class="gameControls">
    	...
    	<button type="button" onclick="startNewGame()" class="pongButton">Start New Game</button>
    	<button type="button" onclick="stopGame()" class="pongButton">Pause Game</button>
    	<button type="button" onclick="resetGame()" class="pongButton">Reset Game</button>
    	<button type="button" onclick="setPlayers(1)" class="pongButton">One Player</button>
    	<button type="button" onclick="setPlayers(2)" class="pongButton">Two Players</button><br />
